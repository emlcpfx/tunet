...
// EZ-Comfy — web port of the tkinter comfy_ui.py. Preset-driven: the form is
// rendered entirely from each preset's `ui` metadata (fetched from
...
// we hand off to the existing job detail page for live render logs + output
// download. (Extra stacked LoRAs beyond a preset's built-in one are a follow-up.)
      ...
      {preset && (
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {doneJob && (
              <Link href={`/demo/jobs/${doneJob}`} className="text-sm font-semibold text-[#7E3AF2] hover:underline">
