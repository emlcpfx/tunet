...
class MainWindow(QMainWindow):
    ...
    def create_main_tab(self):
        ...
        self.model_type_input = QComboBox(); self.model_type_input.addItems(["unet", "msrn"]); self.model_type_input.setCurrentText("unet")
        layout.addRow(QLabel("--- Model Settings ---")); layout.addRow("Model Type:", self.model_type_input); layout.addRow("Model Size Dims:", self.model_size_dims_input); self.tabs.addTab(tab, "Main")
    ...
    def gather_config_from_ui(self):
        ...
        data_config = {'src_dir': get_path(self.src_dir_input), 'dst_dir': get_path(self.dst_dir_input), 'output_dir': get_path(self.model_folder_input), 'resolution': int(self.resolution_input.currentText()), 'overlap_factor': float(self.overlap_factor_input.currentText())}
        if mask_dir:
