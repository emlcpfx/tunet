...
class TrainingTabMixin:
    ...
    def _create_training_tab(self):
        ...
        self.preset_input.setToolTip(
            ...
            "  Beauty / Paint Fix — Small, local fixes: blemishes, wire/rig removal, skin retouch (residual on)\n"
            "  Paintout / Cleanup — Removing large objects and cleaning big areas with smooth blends (residual on)\n"
